...
SQLITE_AMALGAMATION = sqlite-amalgamation-3390000
SQLITE_AMALGAMATION_ZIP_URL = https://sqlite.org/2022/sqlite-amalgamation-3390000.zip
SQLITE_AMALGAMATION_ZIP_SHA3 = 97ab76a9e462b023ff9fef12e6309ae8a20ccf7f6e29d3d5d62a932c92c69fc7
...
out/vfs.bc: src/vfs.c sqlite-src/$(SQLITE_AMALGAMATION)
	mkdir -p out
	# Generate llvm bitcode
	$(EMCC) $(SQLITE_COMPILATION_FLAGS) -s LINKABLE=1 -I sqlite-src/$(SQLITE_AMALGAMATION) -c src/vfs.c -o $@
